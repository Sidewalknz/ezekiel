...
export default function AboutPage() {
  ...
  // Mobile layout state: measure header and check viewport width
  ...
  return (
    <main className={pageStyles.page}>
      <BackgroundFX
        ...
        enableVignette
        enableWobbleY
        overlayCentered={false} /* important: do not center all children */
      >
        ...
        {/* Panels. On mobile, this becomes a scrollable region placed below the header. */}
        <div
          className={isMobile ? fxStyles.contentScrollRegionMobile : undefined}
          style={isMobile ? { top: headerH } : undefined}
        >
          {/* ABOUT */}
          <section
            id="panel-about"
          ...
          >
            <div className={fxStyles.panelBody}>
              <p>
                ...
                Wellington, where I got my Masters in Artificial Intelligence. I’m
                down in Nelson, and I’m basically tech-obsessed, from building out
                mobile apps to websites. When I need a break from the screen, I’m
                usually spending time with my wife and daughter or out playing
                sports. I’m also a huge fan of watching football, F1, and
                basketball. My latest obsession is hardware modding old Guitar Hero
                and Rock Band controllers, swapping parts, and giving them custom
                spray-painted faceplates.
              </p>
            </div>
          </section>
            ...
            <div className={fxStyles.panelBody}>
              ...
              <div className={fxStyles.sectionBlock}>
                ...
                <p>
                  ...
                  project involved predicting salmon health using AI where this was
                  entirely self-guided as no course prepared me for this project. I
                  ended up topping my class for this project.
                </p>
                <p className={fxStyles.badgeRow}>
              ...
              <div className={fxStyles.sectionBlock}>
                ...
                <p>
                  This was the starting point for my information technology career as
                  it allowed me to learn the fundamentals. However I believed that I
                  still had a lot of learning before jumping into a career so I
                  decided to extend my diploma into a degree.
                </p>
                <p className={fxStyles.badgeRow}>
          ...
          >
            <div className={fxStyles.panelBody}>
              <div className={fxStyles.sectionBlock}>
                ...
                <p>
                  I started here as the Purchasing Manager, where I built relationship
                  with the supplier and maintained inventory. My role quickly
                  expanded to include hands-on work where I dealt with surface-mount
                  technology operation and key responsibilities on the manufacturing
                  side. After I left to pursue my diploma and degree, I later
                  returned to the company as their Web Developer, successfully
                  developing and customising their e-commerce platform using Zencart
                  and PHP.
                </p>
                <p className={fxStyles.badgeRow}>
              ...
              <div className={fxStyles.sectionBlock}>
                ...
                <p>
                  My first real job out of school where it prepared myself for the
                  real world. Starting as crew, I quickly moved up the ranks to shift
                  manager. Over the years, I developed strong leadership skills and
                  manageabilty which helped me later in other jobs. I built valuable
                  relationships with regular customers which led me to exciting
                  opportunities and gave me the confidence to network and seek out my
                  next big professional challenge.
                </p>
                <p className={fxStyles.badgeRow}>
